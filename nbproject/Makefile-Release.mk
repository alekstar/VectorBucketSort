...
# Test Files
TESTFILES= \
	${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vectorbucketsort_git
...
${OBJECTDIR}/compile.o: compile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/compile.o compile.cpp

${OBJECTDIR}/src/MathService.o: src/MathService.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MathService.o src/MathService.cpp

${OBJECTDIR}/src/VectorBucketSort.o: src/VectorBucketSort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/VectorBucketSort.o src/VectorBucketSort.cpp
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vectorbucketsort_git: ${TESTDIR}/tests/MathServiceTest.o ${TESTDIR}/tests/VectorBucketSortTest.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc}   -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vectorbucketsort_git $^ ${LDLIBSOPTIONS} 


${TESTDIR}/tests/MathServiceTest.o: tests/MathServiceTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MathServiceTest.o tests/MathServiceTest.cpp


${TESTDIR}/tests/VectorBucketSortTest.o: tests/VectorBucketSortTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/VectorBucketSortTest.o tests/VectorBucketSortTest.cpp
...
${OBJECTDIR}/compile_nomain.o: ${OBJECTDIR}/compile.o compile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/compile_nomain.o compile.cpp;\
	else  \
...
${OBJECTDIR}/src/MathService_nomain.o: ${OBJECTDIR}/src/MathService.o src/MathService.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MathService_nomain.o src/MathService.cpp;\
	else  \
...
${OBJECTDIR}/src/VectorBucketSort_nomain.o: ${OBJECTDIR}/src/VectorBucketSort.o src/VectorBucketSort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/VectorBucketSort_nomain.o src/VectorBucketSort.cpp;\
	else  \
...
.test-conf:
	@if [ "${TEST}" = "" ]; \
	then  \
	    ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vectorbucketsort_git || true; \
	else  \
	    ./${TEST} || true; \
	fi
